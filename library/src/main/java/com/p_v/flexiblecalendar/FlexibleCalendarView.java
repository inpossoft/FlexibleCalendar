...
public class FlexibleCalendarView extends LinearLayout implements
    ...
    private List<Date> datesForMultipleEventView;
    ...
    private void init(AttributeSet attrs) {
        ...
        monthViewPagerAdapter = new MonthViewPagerAdapter(context, displayYear, displayMonth, this, showDatesOutsideMonth, decorateDatesOutsideMonth, startDayOfTheWeek, type);
    ...
    private void setAttributes(AttributeSet attrs) {
        ...
        try {
            ...
            type = a.getInt(R.styleable.FlexibleCalendarView_selectedStateType, 0);
...
*/
    ...
    public void setDatesForMultipleEventView(List<Date> datesForMultipleEventView) {
        this.datesForMultipleEventView = datesForMultipleEventView;
        monthViewPagerAdapter.setDatesWithEventsForMultiple(datesForMultipleEventView);
    }

    public List<Date> getDatesForMultipleEventView() {
        return datesForMultipleEventView;
    }
}
